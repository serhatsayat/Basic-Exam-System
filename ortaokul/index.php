...
<head>
    ...
    function SubForm() {
        $.ajax({
            url: "https://api.apispreadsheets.com/data/pIkxCGB4AiKwVNt5/",
            type: "post",
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-7">
                    <div id="social">
                        <ul>
                            <li><a href="mailto:yourmail@example.com"><i class="icon_mail"></i></a></li>
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-6 col-lg-6 d-flex align-items-center">
                        <div class="main_title_1">
                            <h3 style="color:#FFD700;"> Ortaokul</h3>
                            ...
                            <p style="color:#FFD700;">- SonVeriBukucu</p>
                        </div>
                    </div>
...
?>
                                    ...
                                    <div class="step">
                                        <?php
if ($k == 1) {
    echo '<img src="2.jpg"  width="90" height="80"><br><br>';
} elseif ($k == 5) {
    echo '<img src="6.jpg"  width="90" height="80"><br><br>';
} elseif ($k == 6) {
...
?>
                                        ...
                                        <div class="review_block">
                                            <ul>
                                                ...
                                                <li>
                                                    <div class="checkbox_radio_container">
                                                        <input type="radio" id="<?= $k+1;?>d" name="soru<?= $k+1;?>"
                                                            class="required" value="d">
                                                        <label class="radio" for="<?= $k+1;?>d"></label>
                                                        <label for="<?= $k+1;?>d"
                                                            class="wrapper"><?php  echo $v['d'];?></label>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="submit step">
                                        ...
                                        <h3 class="main_question"><strong><?= $k+1;?> of 19</strong>Lütfen bilgilerinizi
                                            doldurun</h3>
