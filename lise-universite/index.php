...
<head>
    ...
    function SubForm() {
        $.ajax({
            url: "https://api.apispreadsheets.com/data/fBxMfsD1rUOTqzO5/",
            type: "post",
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-6 col-lg-6 d-flex align-items-center">
                        <div class="main_title_1">
                            <h3 style="color:#FFD700;"> Lise/ Üniversite</h3>
...
?>
                                    ...
                                    <div class="submit step">
                                        <h3 class="main_question"><strong><?= $k+1;?> of 50</strong>Lütfen bilgilerinizi
                                            doldurun</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="yas" id="yas" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-9">
